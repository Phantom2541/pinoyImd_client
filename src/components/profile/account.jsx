  ...
  useEffect(() => {
    if (auth._id) {
      ...
      setForm({
        _id: auth._id,
        fullName: {
          fname: auth.fullName?.fname || "",
          mname: auth.fullName?.mname || "",
          lname: auth.fullName?.lname || "",
          suffix: auth.fullName?.suffix || "",
          postnominal: auth.fullName?.postnominal || "",
          title: auth.fullName?.title || "",
        },
        email: auth.email || "",
        dob: auth.dob || "",
