            ...
            <MDBCard>
              <MDBRow className="mt-3">
                ...
                <MDBCol md="7" col="7" className="text-right pr-5">
                  <h5 className="ml-4 mt-4 mb-2 font-weight-bold">567 </h5>
                  <p className="font-small grey-text">Visited Patrons</p>
                </MDBCol>
              </MDBRow>
            ...
            <MDBCard>
              <MDBRow className="mt-3">
                ...
                <MDBCol md="7" col="7" className="text-right pr-5">
                  ...
                  <p className="font-small grey-text">New Patrons</p>
                </MDBCol>
              </MDBRow>
              <MDBRow className="my-3">
                <MDBCol md="7" col="7" className="text-left pl-4">
            ...
            <MDBCard>
              <MDBRow className="mt-3">
                ...
                <MDBCol md="7" col="7" className="text-right pr-5">
                  ...
                  <p className="font-small grey-text">Purchase Amount</p>
                </MDBCol>
              </MDBRow>
              <MDBRow className="my-3">
                <MDBCol md="7" col="7" className="text-left pl-4">
            ...
            <MDBCard className="mb-4">
              <MDBRow>
                <MDBCol md="12" className="text-center">
                  <h5 className="mt-4 mb-4 font-weight-bold">Barangay Sales</h5>
                  <small>Pantabangan</small>
                </MDBCol>
              </MDBRow>
              <MDBCardBody>
                <MDBProgress
                ...
                />
                <p className="font-small grey-text mb-4">San Juan</p>
                <MDBProgress
                  className="mb-2"
                  value={35}
                  barClassName="red accent-2"
                />
                <p className="font-small grey-text mb-4">Villajuan</p>
                <MDBProgress
                  className="mb-2"
                  value={85}
                  barClassName="primary-color"
                />
                <p className="font-small grey-text mb-4">Cikcik</p>
                <MDBProgress
                  className="mb-2"
                  value={70}
                  barClassName="light-blue lighten-1"
                />
                <p className="font-small grey-text mb-4">Luna</p>
              </MDBCardBody>
            </MDBCard>
          </MDBCol>
