            ...
            <MDBRow>
              ...
              <MDBCol md="6">
                ...
                <h6 className="text-warning">
                  <span role="img"> 🟡</span> Gold (10%):{" "}
                  {calculateDiscount(form?.opd, 0.1).toFixed(2)}
                </h6>
                <h6 className="text-light bg-dark p-1 rounded">
                  <span role="img"> ⚪</span> Platinum (15%):{" "}
                  {calculateDiscount(form?.opd, 0.15).toFixed(2)}
                </h6>
                <h6 className="text-info">
                  <span role="img"> 🔹</span> Diamond (20%):{" "}
