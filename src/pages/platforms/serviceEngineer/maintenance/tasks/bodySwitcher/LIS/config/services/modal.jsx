...
export default function ServicesModal() {
  const { showServices: show, selected } = useSelector(
      ({ machines }) => machines
    ),
  ...
  const handleDrop = async (e, _hasSelected) => {
    ...
    <div style="text-align: center;">
      ...
      <div style="font-size: 13px; color: #888; margin-bottom: 10px;">
        This code must be taken from the machine's application. <br />
        Please make sure it is spelled correctly. <br />
          ...
          preConfirm: () => {
            ...
            if (code.length > 16) {
              Swal.showValidationMessage(
                "Code must be 16 characters or fewer."
              );
            }
            return code;
          },
      ...
      <MDBModalBody className="mb-0">
        <MDBRow>
          <Bucket
            ...
            collections={Services.filterByStrTemplate("LAB", selected.section)}
            cluster={cluster}
