...
export default function Past({ past = "surgical" }) {
  ...
  useEffect(() => {
    ...
    const _surgicals = cases.filter((c) => c?.category === past);
    ...
    return (
      <div className="checkup-data-pmh-container d-flex justify-content-center">
        <div className="d-flex justify-content-center mb-3">
          <h3 className="m-auto">No past {past} procedures recorded.</h3>
        </div>
      </div>
    );
  }
  return (
    <div className="checkup-data-mh-container">
      <div className="pshx-container">
        <h2 className="pshx-title">Past {capitalize(past)} History</h2>
