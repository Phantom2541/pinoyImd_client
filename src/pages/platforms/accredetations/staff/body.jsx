...
import { MDBTableHead, MDBTableBody, MDBCardBody, MDBTable } from "mdbreact";
    ...
    <>
      <MDBCardBody>
        ...
        <div>
          ...
          <strong>
            JLO BLDG, B. MENDOZA ST. STO. ROSARIO, CITY OF SAN FERNANDO,
            PAMPANGA
          </strong>
        </div>
              ...
              collections.map((personnels, index) => {
                ...
                return (
                  <tr key={`personnel-${index}`}>
                    <td>
                      {index + 1}. {fullName(user?.fullName).toUpperCase()}
                    </td>
