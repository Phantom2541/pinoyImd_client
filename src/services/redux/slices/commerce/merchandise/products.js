...
const name = "commerce/merchandise/products";
...
export const BROWSE = createAsyncThunk(`${name}/browse`, (data, thunkAPI) => {
  try {
    return axioKit.universal(`${name}/browse`, data.token, data.params);
  } catch (error) {
    const message =
