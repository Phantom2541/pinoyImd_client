...
export const BROWSE = createAsyncThunk(`${name}/browse`, ({ token, branchId }, thunkAPI) => {
  try {
...
export const SAVE = createAsyncThunk(`${name}/save`, ({ data, token }, thunkAPI) => {
  try {
...
export const UPDATE = createAsyncThunk(`${name}/update`, ({ data, token }, thunkAPI) => {
  try {
